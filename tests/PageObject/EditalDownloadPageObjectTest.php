...
class EditalDownloadPageObjectTest extends PageObjectTest
{
    ...
    public function testIfResponseIsOK()
    {
        ...
        $response = $this->client->request('GET', DefaultLink::EDITAL_DOWNLOAD);

        $this->assertEquals(200, $response->getStatusCode());

        return $this->testRetornoHtml($response->getBody()->getContents());
    }
/*    *
     * @depends testIfResponseIsOK
     */
    public function testRetornoHtml($html)
    {
